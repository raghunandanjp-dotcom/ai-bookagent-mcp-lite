...
import { approveSelection, beginSelection, batchCreatures } from "../dist/selection.js";
import { prepareAuthoringPrompts } from "../dist/prompts.js";
import { validateBookContent } from "../dist/validation.js";
import { prepareIllustrationPrompts } from "../dist/illustrations.js";
...
assert.deepEqual(illustrationPrompts.assets.map((asset) => asset.assetId), ["cover", ...creatures.map((creature) => `creature-${creature.id}`)]);
